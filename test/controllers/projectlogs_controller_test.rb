...
class ProjectlogsControllerTest < ActionController::TestCase
  ...
  test "should create projectlog" do
    assert_difference('Projectlog.count') do
      post :create, projectlog: { action: @projectlog.action, actiondata: @projectlog.actiondata, username: @projectlog.username }
    end
  ...
  test "should update projectlog" do
    patch :update, id: @projectlog, projectlog: { action: @projectlog.action, actiondata: @projectlog.actiondata, username: @projectlog.username }
    assert_redirected_to projectlog_path(assigns(:projectlog))
  end
